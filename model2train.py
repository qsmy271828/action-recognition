...
from Code.model2 import ConVNet
...
def train():
    ...
    # plt.show()
        ...
        with open('/home1/rhhHD/Two-stream/model2_results/' + 'train_results.csv', 'a', encoding='utf-8', newline='') as f:
            csv_writer = csv.writer(f)
            csv_writer.writerow([epoch, epoch_loss, epoch_acc, testacc])

        if epoch_acc > best_acc:
            best_acc = epoch_acc
            pkl_name = '/home1/rhhHD/Two-stream/model2_results/' + 'epoch' + str(epoch) + '_loss' + str(epoch_loss) + '_acc' + str(epoch_acc) + '.pkl'
